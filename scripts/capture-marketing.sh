...
LOCALES=(ar da de en es fi fr he hi hu id it ja ko nb nl pl pt-BR ru sv th tr uk vi zh-Hans zh-Hant)
...
for L in "${LOCALES[@]}"; do
    ...
    # Convert hyphens to underscores for AppleLocale (ICU format)
    LOCALE_ID="${L//-/_}"
